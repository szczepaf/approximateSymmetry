...
class SymmetryAproximator(Annealer):
    """This versions of annealing aims to examine which vertices map to which during the annealing process and how it can change against the versions guided by centralities."""
